...
// (50:2) <Register on:close={() => (toggleModal = false)}>
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$1, 50, 4, 960);
			attr_dev(input0, "class", "input");
			attr_dev(input0, "type", "email");
			attr_dev(input0, "placeholder", "email address");
			add_location(input0, file$1, 51, 23, 1067);
			attr_dev(div, "class", "field");
			add_location(div, file$1, 51, 4, 1048);
			attr_dev(input1, "type", "submit");
			input1.value = "Sign Up";
			add_location(input1, file$1, 52, 4, 1161);
			attr_dev(input2, "type", "reset");
			input2.value = "Cancel";
			add_location(input2, file$1, 53, 4, 1230);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(50:2) <Register on:close={() => (toggleModal = false)}>",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$1, 63, 2, 1427);
			...
			add_location(img, file$1, 66, 6, 1513);
			attr_dev(a, "href", "#");
			add_location(a, file$1, 68, 76, 1702);
			attr_dev(p, "class", "is-align-self-center");
			add_location(p, file$1, 68, 6, 1632);
			attr_dev(div1, "class", "container svelte-11qqid");
			add_location(div1, file$1, 65, 4, 1483);
			attr_dev(div2, "class", "hero body svelte-11qqid");
			add_location(div2, file$1, 64, 2, 1455);
			attr_dev(div3, "class", "hero-foot");
			add_location(div3, file$1, 76, 2, 1953);
			attr_dev(section, "class", "hero is-fullheight is-bold svelte-11qqid");
			add_location(section, file$1, 62, 0, 1380);
		},
		m: function mount(target, anchor) {
